...
| Scroll into view (sections) | opacity 0→1, rise 16px, once | `--duration-reveal` 560ms | `--ease-out-expo` | none | `Reveal`, `.ts-reveal` |
...
Nothing but the manifest sequence and the marquee runs longer than 640ms.
