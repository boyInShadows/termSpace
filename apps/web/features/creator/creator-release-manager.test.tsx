...
vi.mock("@/lib/api", async (importOriginal) => {
  ...
  return { ...original, getCreatorReleases: getReleases };
});
  ...
  beforeEach(() => {
    ...
    getReleases.mockResolvedValue({
      ...
      releases: [{
        ...
        status: "published", source: { kind: "github_repository", url: "https://github.com/example/item", ref: "abc123", path: "skill", integrityDigest: null },
